...
| Stage | Automne Hiver Été ou Emploi junior |
| ------: | ----- |
...
Nos finissants en DEC programmation ont suivi une formation centrée sur 2 séquences principales:
...
Au delà de ces 2 axes principaux, les étudiants ont également eu des cours de bases de données, de cybersécurité, d'analyse, de veille technologique et de conception d'interfaces.
##### Stages classiques en DEC programmation

La plupart des stages correspondent à un mandat de **développeur junior**, peu importe le stack technologique. 
...
- Serveurs: une série de cours couvrent les services intranet et internet aussi bien sous **Windows** que **Linux**. On parle de la gestion d'un parc informatique Windows/Linux, d'hébergement de services (web, DHCP, DNS, AD, courriel, etc) et de téléphonie IP
- Réseau: les étudiants ont suivi des cours dans le **stack Cisco** autour de la commutation, du routage et également de la configuration de pare-feu
- Cybersécurité: nos étudiants ont suivi une séquence de **3 cours** qui se concentrent sur la protection et la surveillance d'un réseau informatique ainsi que la mise en place d'une architecture sécuritaire

Nos étudiants ont également démontré une capacité de s'adapter à d'autres stacks technologiques.

##### Stages classiques en DEC TI / réseautique
